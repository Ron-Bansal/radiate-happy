export default function About() {
  return (
    <section className="min-h-screen py-20 px-6 bg-[#F3F5F6] text-black">
      ...
      <div className="mt-60">        <div className="max-w-screen-lg border-b-[0.4px] border-sky-900"></div>

        <h5 className="mt-3 ml-2">
          <span className="inline-block h-2 w-2 bg-black mr-2 mb-[2px]"></span>Particularly passionate
          about these spaces
        </h5>
        ...
        <div className="flex gap-12 mt-6 px-4">
          <div className="flex-col max-w-[230px]">
            ...
            <p className="leading-[123%] text-sm">
              nuturing curiosity ; design thinking;
              knowledge retention
            </p>
          </div>
          ...
          <div className="flex-col max-w-[230px]">
            ...
            <p className="leading-[123%] text-sm">
              intentional social media; meaningful relationships; culural appreciation
            </p>
          </div>
        </div>
      </div>
