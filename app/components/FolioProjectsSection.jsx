...
//     },
//     thumbnailTall: "/assets/moonstone-tall.webp",
//     thumbnailGolden: "/assets/moonstone-golden.webp",
//     thumbnailSquare: "/assets/moonstone-square.webp",
//     accentColor: "#945BA5",
...
//     },
//     thumbnailTall: "/assets/freight-calc-tall.webp",
//     thumbnailGolden: "/assets/freight-calc-golden.webp",
//     thumbnailSquare: "/assets/freight-calc-square.webp",
//     accentColor: "#7FA9C6",
...
//       // metric2_name: "hours saved",
//     },
//     thumbnailTall: "/assets/2asterisk-tall.webp",
//     thumbnailGolden: "/assets/2asterisk-golden.webp",
//     thumbnailSquare: "/assets/2asterisk-square.webp",
//     accentColor: "#718b7b",
...
const projects = [
  ...
  },
  {
    ...
    thumbnailTall: "/assets/3asterisk-tall.webp",
    thumbnailGolden: "/assets/3asterisk-golden.webp",
    thumbnailSquare: "/assets/3asterisk-square.webp",
    accentColor: "#c6ae8b",
    backgroundColor: "#E1D4BF",
    glassBg:
      "radial-gradient(circle at 50% 40%, rgba(239, 222, 196, 0.9), transparent 260%)",
    caseStudyLink: "/work/asterisk",
    liveSiteLink: "https://www.figma.com/community/design-tools?resource_type=plugins",
  },
];
...
export default function ProjectsSection() {
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      // Add a small delay before initializing ScrollTrigger to ensure DOM is fully loaded
      const timer = setTimeout(() => {
        // Refresh ScrollTrigger to ensure proper pinning and animations
        ScrollTrigger.refresh();
        
        // Optional: Add a scroll-driven horizontal line to visualize progress
