  ...
  return (
    ...
    <section className="min-h-screen py-20 px-6">
      ...
      <div className="bg-[#F3F5F6] text-gray-950 w-2/4 py-4 px-5 rounded shadow-xl float-right relative">
        ...
        <h4 className="text-sky-700 font-medium text-lg leading-snug">RAUNAQ</h4>
        <div className="flex gap-2 items-center">
          <p>/raʊnək/</p>
          <Volume2 className="h-5 cursor-pointer" />
        </div>
        <p className="text-gray-500 italic text-sm leading-none mb-2">noun.</p>
        <div className="">
          <ol className="list-decimal list-inside leading-[1.7]">
            <li className="mb-2">
              In Hindi poetry,{" "}
              <span className="font-accent text-xl text-sky-950">‘Raunaq’</span> is often
