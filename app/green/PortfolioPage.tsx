...
export default function PortfolioPage() {
  ...
  return (
    <>
      <main className="min-h-screen bg-fixed xbg-[#FBEDC6] text-[#1C180C] bg-[length:auto_120%] lg:bg-cover bg-[position:50%_65%] lg:bg-center bg-no-repeat xbg-[url('')] bg-[url('/assets/garden/hilly-gradient2.webp')]">
